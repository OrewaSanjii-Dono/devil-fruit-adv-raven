...
on_pic = "https://envs.sh/omB.jpg"
off_pic = "https://envs.sh/omB.jpg"
...
➪ ᴄʟᴇᴀʀ ᴜsᴇʀs ɪs ᴜsᴇᴅ ᴛᴏ ᴄʟᴇᴀʀ ᴛʜᴇ ᴀʟʟ ᴜsᴇʀ ᴅᴀᴛᴀ ᴏғ ᴀ sᴘᴇᴄɪғɪᴇᴅ ʀᴇǫᴜᴇsᴛ ғᴏʀᴄᴇsᴜʙ cʜᴀɴɴᴇʟ ɪᴅ. 

➪ ʜᴇʀᴇ oɴʟʏ usᴇʀ ᴅᴀᴛᴀ ɪs ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ sᴘᴇᴄɪғɪᴇᴅ ᴄʜᴀɴɴᴇʟ.
...
➪ ᴄʟᴇᴀʀ ᴄʜᴀɴɴᴇʟs ᴜsᴇᴅ ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴀʟʟ ᴜsᴇʀ ᴅᴀᴛᴀ ᴀʟᴏɴɢ ᴡɪᴛʜ Rᴇǫᴜᴇsᴛ ғᴏʀᴄᴇsᴜʙ ᴄʜᴀɴɴᴇʟ ɪᴅ ᴀɴᴅ ʟɪɴᴋ ғʀᴏᴍ ᴅᴀᴛᴀʙᴀsᴇ. 

➪ ʜᴇʀᴇ ᴀʟʟ ᴅᴀᴛᴀ ʀᴇᴀʟᴛᴇᴅ ᴛᴏ ʀᴇǫᴜᴇsᴛ ғᴏʀᴄᴇsᴜʙ ᴄʜᴀɴɴᴇʟ ɪᴅ ᴅᴇʟᴇᴛᴇᴅ Pᴇʀᴍᴀɴᴇɴᴛʟʏ...
...
➪ Cʟᴇᴀʀ sᴛᴏʀᴇᴅ ʀᴇᴏ̨ᴜᴇsᴛ ʟɪɴᴋs ᴜsᴇᴅ ᴛᴏ ᴅᴇʟᴇᴛᴇ ʟɪɴᴋs ᴏғ ᴀ sᴘᴇᴄɪғɪᴇᴅ ᴄʜᴀɴɴᴇʟ ɪɴ ᴅᴀᴛᴀʙᴀsᴇ ᴀs ᴡᴇʟʟ ᴀs ʀᴇᴠᴏᴋᴇ ᴛʜᴇ ʟɪɴᴋ ғʀᴏᴍ ᴛʜᴀᴛ Cʜᴀɴɴᴇʟ. 
...
‣ Iғ ᴛʜᴇ ʙᴏᴛ ɴᴏᴛ ɪɴ ᴛʜᴀᴛ ᴄʜᴀɴɴᴇʟ ᴏʀ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀᴅᴍɪɴ ᴘᴇʀᴍɪssɪᴏɴ ᴛʜᴇɴ ᴛʜɪs ᴏᴘᴇʀᴀᴛɪᴏɴ ᴄᴀɴ'ᴛ ʙᴇ ᴘᴇʀғᴏʀᴍᴇᴅ.
